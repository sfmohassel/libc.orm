...
namespace libc.orm.DatabaseConnection
{
    public class CompilerHelper
    {
        ...
        {
            if (c is PostgresCompiler) return $" = ANY ({inQueryOrParameter})";
        ...
        public class CompilerSelectHelper
        {
            ...
            private class Col
            {
                ...
                public static IEnumerable<Col> _AliasWithCustomPrefix(Compiler c, bool quote, Type type,
                ...
                private static IEnumerable<Col> _create(Type type, string[] excludedProperties,
                    Func<string, Col> resolve)
                {
