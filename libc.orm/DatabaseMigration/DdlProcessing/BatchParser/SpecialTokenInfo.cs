...
namespace libc.orm.DatabaseMigration.DdlProcessing.BatchParser {
    ...
    public class SpecialTokenInfo {
        ...
        /// <remarks>
        ///     The <paramref name="index" /> may not point to the real token text and the <paramref name="length" /> might be
        ///     longer
        ///     than the <paramref name="token" /> itself. This is usually the case when the token should be the only text on the
        ///     line,
