    ...
    public abstract class GenericGenerator : GeneratorBase
    {
        ...
        public override string Generate(CreateTableExpression expression)
        {
            if (string.IsNullOrEmpty(expression.TableName))
                throw new ArgumentNullException(nameof(expression), Dmt.ExpressionTableNameMissing);
        ...
        public override string Generate(CreateColumnExpression expression)
        {
            ...
            return string.Format(AddColumn, Quoter.QuoteTableName(expression.TableName, expression.SchemaName),
        ...
        public override string Generate(AlterColumnExpression expression)
        {
            ...
            return string.Format(AlterColumn, Quoter.QuoteTableName(expression.TableName, expression.SchemaName),
                Column.Generate(expression.Column));
        }
        ...
        public override string Generate(DeleteColumnExpression expression)
        {
            ...
            {
                if (expression.ColumnNames.First() != columnName) AppendSqlStatementEndToken(builder);

                builder.AppendFormat(DropColumn, Quoter.QuoteTableName(expression.TableName, expression.SchemaName),
        ...
        {
            return string.Format(DropIndex, Quoter.QuoteIndexName(expression.Index.Name),
                Quoter.QuoteTableName(expression.Index.TableName, expression.Index.SchemaName));
        }
        ...
        public override string Generate(InsertDataExpression expression)
        {
            ...
            {
                if (output.Length != 0) AppendSqlStatementEndToken(output);
        ...
        public override string Generate(UpdateDataExpression expression)
        {
            ...
            return string.Format(UpdateData, Quoter.QuoteTableName(expression.TableName, expression.SchemaName),
                string.Join(", ", updateItems.ToArray()), string.Join(" AND ", whereClauses.ToArray()));
        }
        ...
        public override string Generate(DeleteDataExpression expression)
        {
            ...
            if (expression.IsAllRows)
                deleteItems.Add(string.Format(DeleteData,
                    Quoter.QuoteTableName(expression.TableName, expression.SchemaName), "1 = 1"));
            else
                foreach (var row in expression.Rows)
                {
                    var whereClauses = new List<string>();
        ...
        public override string Generate(CreateSequenceExpression expression)
        {
            ...
            if (seq.Increment.HasValue) result.AppendFormat(" INCREMENT {0}", seq.Increment);
