...
namespace libc.orm.DatabaseMigration.Abstractions.Model
{
    ...
    /// </summary>
    public class ColumnDefinition : ICloneable, ISupportAdditionalFeatures, IValidatableObject
    {
        /// <summary>
        ///     Gets or sets the column definition name
        /// </summary>
        [Required(ErrorMessageResourceName = "ColumnNameCannotBeNullOrEmpty", ErrorMessageResourceType = typeof(Dmt))]
        ...
        {
            if (Type == null && CustomType == null) yield return new ValidationResult(Dmt.ColumnTypeMustBeDefined);
        }
