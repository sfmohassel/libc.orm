...
namespace libc.orm.DatabaseMigration.Abstractions.Expressions {
    ...
    public class RenameColumnExpression : MigrationExpressionBase, ISchemaExpression {
        ...
        /// </summary>
        [Required(ErrorMessageResourceType = typeof(Dmt),
            ErrorMessageResourceName = nameof(Dmt.OldColumnNameCannotBeNullOrEmpty))]
        public virtual string OldName { get; set; }
        /// <summary>
        ///     Gets or sets the new column name
        /// </summary>
        [Required(ErrorMessageResourceType = typeof(Dmt),
            ErrorMessageResourceName = nameof(Dmt.NewColumnNameCannotBeNullOrEmpty))]
        ...
        public override IMigrationExpression Reverse() {
            return new RenameColumnExpression {
